                ...
                <asp:Repeater ID="booksRepeater" ItemType="Book" runat="server" OnItemCommand="booksRepeater_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%#: Item.Author %></td>
                            <td>
                                <asp:Button runat="server" ID="editButton" CssClass="btn btn-outline-warning" Text="Edit" CommandArgument='<%# Eval("ID") %>' CommandName="Edit" /></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
            </table>
            <asp:Repeater ID="rptPager" runat="server">
                <ItemTemplate>
                    <asp:LinkButton ID="lnkPage" runat="server" Text='<%#Eval("Text") %>' CommandArgument='<%# Eval("Value") %>'
                        CssClass='<%# Convert.ToBoolean(Eval("Enabled")) ? "page_enabled" : "page_disabled" %> link-secondary'
