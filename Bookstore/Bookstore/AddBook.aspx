            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div>
                            <asp:Button runat="server" ID="addAuthor" data-dismiss="modal" CssClass="btn btn-outline-success" Text="Add" OnClick="addAuthorButton_Click" />
                        </div>
        ...
        <div class="modal fade" id="newGenreView" runat="server" tabindex="-1" role="dialog" aria-labelledby="genreLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div>
                            <asp:Button runat="server" ID="addGenre" data-dismiss="modal" CssClass="btn btn-outline-success" Text="Add" OnClick="addGenreButton_Click" />
                        </div>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
                </div>
